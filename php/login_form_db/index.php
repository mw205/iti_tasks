    ...
    <div class="container mt-5">
        <form action="controller.php?action=add" method="post" onsubmit="return doValidation()">
            <div class="mb-3">
                ...
                <input id="FirstName" class="form-control" type="text" name="user_data[f_name]">
            </div>
            <div class="mb-3">
                <label class="form-label" for="LastName">Last Name</label>
                <input id="LastName" class="form-control" type="text" name="user_data[l_name]">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" name="user_data[address]" id="address"></textarea>
            </div>
            <div class="mb-3">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="user_data[gender]" value="female" id="gender_female">
            ...
            <div class="mb-3">
                ...
                <input class="form-control" type="text" name="user_data[username]" id="username">
            </div>
            <div class="mb-3">
                <label class="form-label" for="email">Email</label>
                <input class="form-control" type="text" name="user_data[email]" id="email">
            </div>
            <div class="mb-3">
                <label class="form-label" for="password">Password</label>
                <input class="form-control" type="password" name="user_data[password]" id="password">
            </div>
            <div class="mb-3">
                <label class="form-label" for="department">Department</label>
                <input class="form-control" type="text" name="user_data[department]" id="department" value="OpenSource" readonly>
            </div>
            <div class="mb-3">
                <?php
