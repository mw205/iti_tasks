  ...
  [
    {
      ...
      "image": "https://hips.hearstapps.com/vader-prod.s3.amazonaws.com/1762194818-71rOOcpmMqL.jpg",
      "badge": "NEW",
      "price": 120,
      "discount": 20,
      "stock": 10,
    ...
    },
    {
      ...
      "image": "https://static.nike.com/a/images/t_web_pdp_936_v2/f_auto/7b8a22e5-67b8-4893-a9ab-eca50ea73d1b/W+NIKE+CALM+FLIP+FLOP.png",
      "badge": "",
      "price": 30,
      "discount": 50,
      "stock": 20,
...
const handleBuy = (boughtProductId) => {
  const product = products.value.find(product => product.id === boughtProductId);
...
<template>
  <NavBar :shop-name="shopName" :links="links" />
  <main class="p-8">
