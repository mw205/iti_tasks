...
void printEmployeeDetails(Emp emp);
void addNewEmployee(Emp employees[], int index);
void addNewMultipleEmployees(Emp employees[], int arrSize);
void displayAllEmployees(Emp employees[], int arrSize);
void displayEmployeeByNumber(Emp employees[], int arrSize);
...
void addNewEmployee(Emp employees[], int index)
{
    ...
    cin.getline(employees[index].name, sizeof(employees[index].name));

    do
    {
        cout << "Enter New Employee Salary : ";
        cin >> employees[index].salary;
    } while (employees[index].salary < 0);
